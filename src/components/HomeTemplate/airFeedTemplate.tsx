...
import { Button, Icon, Image, Paragraph, ModalDialogCommon } from '~Root/components';
import HeaderNormalBlue from '~Root/components/HeaderNormalBlue/new';
        ...
        <TouchableOpacity
          ...
          <View style={[GlobalStyles.flexRow, styles.headerWrapper]}>
            ...
            <View style={[styles.userInfoArea, GlobalStyles.ml10, { flex: 8 }]}>
              <Paragraph p bold600 textBlack title={getUserName()} style={[GlobalStyles.mb5, styles.title]} />
              {checkProfileTitle(profile?.title) && (
                <Paragraph
                  p
                  textBlack
                  title={profile?.title}
                  style={[GlobalStyles.mb20, styles.title, styles.biztype]}
                />
              )}
            </View>
          </View>
          <View style={GlobalStyles.fullWidth}>
            <Paragraph p textBlack title={ask?.askType?.name} style={GlobalStyles.mb10} />
            <Paragraph
              h5
              bold
              textBlack
