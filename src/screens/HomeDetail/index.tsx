...
const HomeDetailScreen = ({navigation, route}: Props) => {
  ...
  const editPermission = moment(moment()).diff(data_ask_selected?.createdAt, 'minute') > 65;
    ...
    <View style={styles.container}>
      <ScrollView>
        <View style={[GlobalStyles.pt20, styles.header]}>
          <TouchableOpacity
            onPress={onBack}
            style={[GlobalStyles.flexRow, GlobalStyles.pl20, GlobalStyles.alignCenter, GlobalStyles.alignBaseline]}>
            <Text>
              <AngleLeft />
            </Text>
          ...
          <View style={[GlobalStyles.mh30, GlobalStyles.mt20]}>
            <View
              style={[
                ...
                !data_ask_selected?.endDate && {justifyContent: 'flex-end'},
              ]}>
              ...
              {data_ask_selected?.userCode === userInfo.code && (
                <Tooltip
                  ...
                  content={
                    <View>
                      <TouchableOpacity
                        style={[GlobalStyles.flexRow, GlobalStyles.alignCenter, styles.menuItem]}
                        onPress={editPermission ? onEdiAsk : () => {}}
                        activeOpacity={editPermission ? 0.6 : 1}>
                        <MenuEdit enabled={editPermission} />
                        <Paragraph
                          h5
                          textGray={!editPermission}
                          textBlack={editPermission}
                          bold600
                          title={t('edit_ask')}
                      ...
                      <TouchableOpacity
                        style={[GlobalStyles.flexRow, GlobalStyles.alignCenter, GlobalStyles.pv10]}
                        onPress={onPress}
                        activeOpacity={0.6}>
                        <MenuEnd />
              ...
              <Paragraph
                ...
                title={
                  data_ask_selected?.noEndDate
                    ? t('no_deadline')
                    : `${moment(data_ask_selected?.endDate).format('MMM DD YYYY')}`
                }
                style={styles.fontNotoSan}
              />
            </View>
          </View>
          <Text>
            ...
            {!data_ask_selected?.isEnd && (
              <View style={styles.buttonGroup}>
                <ButtonSecond
                  ...
                  titleStyle={styles.whiteText}></ButtonSecond>
                <ButtonSecond
                  isIconLeft={true}
                ...
                <ButtonSecond
                  ...
                  iconColor={BASE_COLORS.whiteColor}></ButtonSecond>
              </View>
            )}
          </>
        ) : (
